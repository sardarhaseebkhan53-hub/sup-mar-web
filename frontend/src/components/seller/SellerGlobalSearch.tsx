  ...
  return (
    <div ref={boxRef} className="relative hidden min-w-0 flex-1 md:block" role="search" aria-label="Search your business">
      ...
      {open && debounced.length >= 2 && (
        <div className="absolute start-0 end-0 top-12 z-50 overflow-hidden rounded-panel border bg-white shadow-floating" role="listbox" aria-label="Search results">
          ...
          {results && total > 0 && <div className="max-h-80 overflow-y-auto divide-y text-start">
