export const en = {
  common: {
    brand: 'DealHub', tagline: 'Buy. Sell. Discover.', continue: 'Continue', back: 'Back', cancel: 'Cancel', save: 'Save changes', loading: 'Please wait…',
  ...
  auth: {
    welcome: 'Welcome back', loginTitle: 'Log in to DealHub', loginSubtitle: 'Pick up your conversations, saved finds, and seller tools securely.',
    ...
    phoneOtp: 'Use phone OTP instead', socialUnavailable: 'Social sign-in is not configured yet', noAccount: 'New to DealHub?', createAccount: 'Create an account',
    join: 'Join the community', registerTitle: 'Create your DealHub account', registerSubtitle: 'A short, secure setup. You can complete your profile later.',
    emailMethod: 'Continue with email', phoneMethod: 'Continue with phone', customer: 'I want to buy', seller: 'I want to sell too', accountIntent: 'How will you use DealHub?',
    ...
    checkingLink: 'Checking verification link…', emailVerified: 'Email verified', emailVerifiedBody: 'Your DealHub identity is ready. You can now sign in and continue.',
    ...
    protectedTitle: 'Sign in to continue', protectedBody: 'DealHub requires a verified profile before messaging, saving, reporting, or selling. You will return to where you left off.',
  ...
  security: {
    title: 'Security & sessions', subtitle: 'Control passwords, active devices, and sensitive account actions.', activeSessions: 'Active sessions', currentDevice: 'Current device', lastActive: 'Last active', loginTime: 'Login time', location: 'Approximate location', logoutDevice: 'Log out this device', logoutAll: 'Log out all devices', logoutAllConfirm: 'This closes every active DealHub session, including this one.',
    ...
    accountLink: 'Account linking', accountLinkBody: 'Link duplicate email/phone identities only after password, OTP, and explicit confirmation. DealHub never merges accounts automatically.',
  },
  dashboard: {
