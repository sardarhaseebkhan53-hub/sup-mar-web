...
export default function OtpVerificationPage() {
  ...
  if (success) return <div className="text-center"><span className="mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-emerald-100 text-emerald-700"><CheckCircle2 size={30} /></span><h1 className="mt-5 text-3xl font-extrabold">Phone verified</h1><p className="mt-3 text-sm text-slate-500">Your trusted DealHub identity has been updated.</p></div>;
