  ...
  return (
    <div className="container-shell py-7 sm:py-10">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-end"><div><p className="eyebrow">Sell on DealHub</p><h1 className="mt-1 text-3xl font-extrabold">Create a great listing</h1><p className="mt-2 text-sm text-slate-500">Clear details and quality photos help your item sell faster.</p></div><span className="rounded-full bg-emerald-50 px-3 py-1.5 text-[11px] font-extrabold text-emerald-700">Draft saved</span></div>
