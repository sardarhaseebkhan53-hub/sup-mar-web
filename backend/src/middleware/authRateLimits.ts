...
export const referralRateLimit = makeLimiter(15 * 60_000, 20, 'Too many referral actions. Try again later.', 'REFERRAL_RATE_LIMITED');
export const couponRateLimit = makeLimiter(60_000, 20, 'Too many coupon actions. Try again shortly.', 'COUPON_RATE_LIMITED');
export const couponValidationRateLimit = makeLimiter(60_000, 30, 'Too many coupon validations. Try again shortly.', 'COUPON_VALIDATION_RATE_LIMITED');
export const campaignRateLimit = makeLimiter(60_000, 60, 'Too many campaign interactions. Please wait.', 'CAMPAIGN_RATE_LIMITED');
export const growthRateLimit = makeLimiter(60_000, 60, 'Too many growth requests. Try again shortly.', 'GROWTH_RATE_LIMITED');
export const shareRateLimit = makeLimiter(60_000, 60, 'Too many share actions. Try again shortly.', 'SHARE_RATE_LIMITED');
export const rewardClaimRateLimit = makeLimiter(10 * 60_000, 20, 'Too many reward actions. Try again shortly.', 'REWARD_CLAIM_RATE_LIMITED');
