...
const schema = new mongoose.Schema<any>({
  ...
  subject: { type: String, trim: true, maxlength: 160, default: 'Support request' },
  category: { type: String, enum: SUPPORT_CATEGORIES, required: true, index: true },
  description: { type: String, required: true, maxlength: 4000 },
  priority: { type: String, enum: SUPPORT_PRIORITIES, default: 'medium', index: true },
...
schema.index({ assignedTo: 1, status: 1, updatedAt: -1 });
