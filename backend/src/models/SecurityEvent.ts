...
const securityEventSchema = new mongoose.Schema<any>({
...
export const SecurityEvent: mongoose.Model<any> = (mongoose.models.SecurityEvent as mongoose.Model<any>) || mongoose.model<any>('SecurityEvent', securityEventSchema);
