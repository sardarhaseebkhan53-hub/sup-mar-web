...
adminUserRouter.use(asyncHandler(authenticateAdmin), authorize(USER_ROLES.ADMIN, USER_ROLES.SUPER_ADMIN, USER_ROLES.MODERATOR, USER_ROLES.SUPPORT, USER_ROLES.FINANCE));
