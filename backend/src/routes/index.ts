...
import { sellerCouponRouter } from './sellerCouponRoutes.js';
import { adminCouponRouter } from './adminCouponRoutes.js';
import { adminCampaignRouter } from './adminCampaignRoutes.js';
...
apiRouter.use('/user/rewards', rewardRouter);
apiRouter.use('/seller/coupons', sellerCouponRouter);
apiRouter.use('/seller/campaigns', sellerGrowthRouter);
apiRouter.use('/seller/growth', sellerGrowthRouter);
